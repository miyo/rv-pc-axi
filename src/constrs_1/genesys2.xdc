...
set_property -dict { PACKAGE_PIN V27   IOSTANDARD LVCMOS33 } [get_ports { w_txd_phy[0] }]; #IO_L16N_T2_A15_D31_14 Sch=jd[1]
set_property -dict { PACKAGE_PIN Y30   IOSTANDARD LVCMOS33 } [get_ports { w_rxd_phy[1] }]; #IO_L8P_T1_13 Sch=jd[2]
set_property -dict { PACKAGE_PIN V24   IOSTANDARD LVCMOS33 } [get_ports { w_crs_dv_phy }]; #IO_L23N_T3_A02_D18_14 Sch=jd[3]
...
set_property -dict { PACKAGE_PIN AE24  IOSTANDARD LVCMOS33 } [get_ports { sd_rst }]; #IO_L12N_T1_MRCC_12 Sch=sd_reset
