...
set files [list \
 [file normalize "${origin_dir}/src/sources_1/ip/genesys2/mig_7series_0_axi/mig_a.prj" ]\
 [file normalize "${origin_dir}/src/sources_1/ip/genesys2/clk_wiz_1/clk_wiz_1.xci" ]\
 ...
 [file normalize "${origin_dir}/src/sources_1/rtl/genesys2.v" ]\
...
set file "genesys2/clk_wiz_1/clk_wiz_1.xci"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "genesys2" -objects $obj
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/sources_1/ip/genesys2/clk_wiz_0/clk_wiz_0.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "genesys2/clk_wiz_0/clk_wiz_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/sources_1/ip/genesys2/mig_7series_0_axi/mig_7series_0_axi.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "genesys2/mig_7series_0_axi/mig_7series_0_axi.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/sources_1/ip/genesys2/clk_wiz_2/clk_wiz_2.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "genesys2/clk_wiz_2/clk_wiz_2.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/src/sources_1/ip/genesys2/clk_wiz_3/clk_wiz_3.xci" ]\
]
set added_files [add_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "genesys2/clk_wiz_3/clk_wiz_3.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
set file "[file normalize "$origin_dir/src/constrs_1/genesys2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "constrs_1/genesys2.xdc"
